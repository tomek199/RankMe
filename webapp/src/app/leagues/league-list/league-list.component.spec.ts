...
describe('LeagueListComponent', () => {
  ...
  it('should load next leagues page after button click', () => {
    ...
    const nextPageButton = fixture.debugElement.queryAll(By.css('button.mat-icon-button'))[1];
    ...
    expect(nextPageButton.nativeElement.disabled).toBeTrue()
  });
  ...
  it('should load previous leagues page after button click', () => {
    ...
    const previousPageButton = fixture.debugElement.queryAll(By.css('button.mat-icon-button'))[0];
    previousPageButton.triggerEventHandler('click', null)
    fixture.detectChanges()
    // check leagues list and button state
    const listOptions = fixture.nativeElement.querySelectorAll('mat-list-option');
    expect(listOptions.length).toEqual(previousLeaguesPage.edges.length);
    expect(previousPageButton.nativeElement.disabled).toBeTrue()
  });
