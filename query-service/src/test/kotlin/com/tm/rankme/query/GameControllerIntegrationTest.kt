...
internal class GameControllerIntegrationTest {
    ...
    @Test
    internal fun `Should return page for completed games by league id`() {
        // given
        val leagueId = randomNanoId()
        val entities = listOf(
            GameEntity(
    ...
    @Test
    internal fun `Should return empty page for completed games by league id`() {
        // given
        val leagueId = randomNanoId()
        every {
    ...
    @Test
    internal fun `Should return page for scheduled games by league id`() {
        // given
        val leagueId = randomNanoId()
        val entities = listOf(
            GameEntity(
    ...
    @Test
    internal fun `Should return empty page for scheduled games by league id`() {
        // given
        val leagueId = randomNanoId()
        every {
