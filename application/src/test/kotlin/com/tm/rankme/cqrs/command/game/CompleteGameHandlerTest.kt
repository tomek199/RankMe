...
internal class CompleteGameHandlerTest {
    ...
    private val handler: CommandHandler<CompleteGameCommand> = CompleteGameHandler(repository, playerPort)
    ...
    internal fun `Should create played game`() {
        ...
        val game = Game.scheduled(leagueId, LocalDateTime.now(), UUID.randomUUID(), UUID.randomUUID())
